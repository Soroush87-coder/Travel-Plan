...
import { EMBLEM, LOGO } from "./logo-data";
    ...
    <div className="tg-root">
      ...
      <nav className="nav no-print">
        <div className="nav-inner">
          <a className="brand" href="#top">
            <span className="brand-chip"><img src={EMBLEM} alt="Travel Market" /></span>
      ...
      <header className="hero no-print" id="top">
        <div className="hero-wrap">
          ...
          <span className="hero-emblem"><img src={EMBLEM} alt="Travel Market" /></span>
            ...
            <div className="doc-pad">
              <div className="doc-head">
                <div className="doc-brand">
                  <span className="doc-chip"><img src={EMBLEM} alt="Travel Market" /></span>
                  <div>
      ...
      <footer className="footer no-print">
        <img src={LOGO} alt="Travel Market — سوق السفر للسياحة" />
